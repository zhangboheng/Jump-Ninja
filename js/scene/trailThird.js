...
export default class TrailThird {
  ...
  drawGoal() {
    if (this.endImage.complete) {
      this.context.drawImage(this.endImage, this.canvas.width / 2 - 50 * scaleX - 16 * scaleY, this.canvas.height - 800 * scaleY - 64 * scaleY + this.ninja.groundY, 64 * scaleX, 64 * scaleY);
    }
  }
  // 绘制返回按钮
  drawBack() {
