...
export default class TrailFirst {
  ...
  drawGoal() {
    if (this.endImage.complete) {
      this.context.drawImage(this.endImage, this.canvas.width / 2 - 80 * scaleX - 16 * scaleY, this.canvas.height - 550 * scaleY - 64 * scaleY + this.ninja.groundY, 64 * scaleY, 64 * scaleY);
    }
  }
  // 绘制返回按钮
  drawBack() {
