...
export default class Trailsixth {
  ...
  drawGoal() {
    if (this.endImage.complete && this.boards[6].clockLimit >= 2) {
      this.context.drawImage(this.endImage, this.canvas.width / 2 + 90 * scaleX - 16 * scaleY, this.canvas.height - 1600 * scaleY - 64 * scaleY + this.ninja.groundY, 64 * scaleY, 64 * scaleY);
    }
  }
  // 绘制返回按钮
  drawBack() {
