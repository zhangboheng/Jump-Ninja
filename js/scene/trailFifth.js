...
export default class Trailfifth {
  constructor(game) {
    ...
    this.boardsLeft = [{
      ...
      y: this.canvas.height - 750 * scaleY,
      width: 12 * scaleX,
      height: 150 * scaleY,
      type: 'wood',
      smooth: 1,
      ...
      y: this.canvas.height - 1000 * scaleY,
      width: 8 * scaleX,
      height: 120 * scaleY,
      type: 'metal',
      smooth: 0.01,
  ...
  drawMessageBox() {
    if(this.displayMessageTime > 0) {
      showBoxMessage(this.context, '试炼 - 05', this.canvas.width / 2, this.canvas.height / 2, '#f5d659', 'black', 20 * scaleX);
      setTimeout(() => {
